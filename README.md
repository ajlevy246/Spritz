...
2. **Monte Carlo Path Tracing:** Implementing more advanced lighting simulations and microfacet surface models involves a more complex rendering equation thats capable of simulating subsurface scattering.
3. **Procedural Textures:** Objects with procedural textures allow for materials that look much more realistic (think wood grain, tiling, metals, et cetera).
...
![Sitting on a matte plane are dimly lit spheres and glass prisms]([https://github.com/ajlevy246/Spritz-/blob/main/progress/tray.png?raw=true](https://github.com/ajlevy246/Spritz-/blob/main/progress/tray.png?raw=true))
