...
![Inverse Problem - Ground Truth](./Inverse_Problem_Example/snowden_gt.png = 250x250)
...
![Inverse Problem - Initial Conditions](./Inverse_Problem_Example/initial_guess.png = 250x250)
